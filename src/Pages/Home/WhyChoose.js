    ...
    <div className="px-12">
      <div className="flex flex-col w-full border-5 border-opacity-50 lg:w-full">
        ...
        <div className="text-xl text-emerald-900">
          There are dozens of reasons why our clients choose Green Bikester{" "}
          <br /> as their bike service provider of choice.
        </div>
        <div className="divider grid place-items-center h-1 px-24 bg-gradient-to-r from-white via-emerald-900 to-white"></div>
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 py-10 my-5">
        ...
        <WhyChooseCard
          ...
          img={
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8Q3KAVSxKFqxXOoz_0PyCDD1MGtyxmFRdOA&usqp=CAU"
          }
        ></WhyChooseCard>
        <WhyChooseCard
          ...
          img={
            "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQXMtg0S4YUl2exZ4BsGqgU_sSBDoP6KbG_Lg&usqp=CAU"
          }
        ></WhyChooseCard>
      </div>
    </div>
